...
enum GuardString: CaseIterable {
 ...
 var message: LocalizedMessage {
  ...
  case .notifyBody: return LocalizedMessage("无法确认安全路径，Watcher已撤销放行许可。请打开App查看过滤器状态与原因；执行未确认时不能视为已阻断。","The safe route could not be confirmed. Watcher has withdrawn permission to connect. Open the app for filter status and details; unconfirmed enforcement does not mean traffic is blocked.")
  ...
  case .previewTitle: return LocalizedMessage("Watcher · 离线预览","Watcher · Offline Preview")
  case .heading: return LocalizedMessage("Claude 进程与连接保护","Claude processes and connection protection")
  case .subtitle: return LocalizedMessage("联网由Surge负责。Watcher不提供代理/VPN，不建立SSH，不读取VPS私钥。","Surge handles network traffic. Watcher provides no proxy, VPN, or SSH tunnel and does not read VPS private keys.")
  ...
  case .open: return LocalizedMessage("打开Watcher","Open Watcher")
  case .quitMenu: return LocalizedMessage("退出Watcher…","Quit Watcher…")
  ...
  case .disableHelp: return LocalizedMessage("停用后Watcher不再阻止Claude直连。","After disabling, Watcher will no longer prevent Claude from connecting directly.")
  ...
  case .quitApp: return LocalizedMessage("退出Watcher","Quit Watcher")
